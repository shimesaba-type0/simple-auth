# GitHub Issues - 実装タスク一覧

このドキュメントには、simple-auth実装のための全issueが含まれています。
各issueをGitHub UIで手動作成してください。

---

## Phase 1: 基盤構築

### Issue #4: プロジェクトセットアップ（Go + SQLite3）
...
### Issue #12: auth_request エンドポイント実装
...
### Issue #26: READMEと実装ガイド作成
**Labels**: `enhancement`, `phase-7`, `documentation`
...
### Phase 別 Issue 数
- **Phase 1**: 基盤構築 (3 issues)
- **Phase 2**: 認証機能（コア） (5 issues)
- **Phase 3**: nginx連携 (2 issues)
- **Phase 4**: ユーザー機能 (3 issues)
- **Phase 5**: 管理者機能 (5 issues)
- **Phase 6**: セキュリティ強化 (2 issues)
- **Phase 7**: テスト・デプロイ (3 issues)

**合計**: 23 issues

### 推奨実装順序
1. Phase 1 (#4 → #5 → #6)
2. Phase 2 (#7 → #8 → #9 → #10 → #11)
3. Phase 3 (#12 → #13)
4. Phase 4, 5, 6 並行実装可能
5. Phase 7 最後
